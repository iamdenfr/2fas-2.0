...
export const register = (user) => async (dispatch) => {
  try {
    ...
    const response = await axios.post("http://192.168.1.103:8000/api/auth/register", user);
...
export const login = (email, password) => async (dispatch) => {
  try {
    ...
    const response = await axios.post("http://192.168.1.103:8000/api/auth/login", user);
